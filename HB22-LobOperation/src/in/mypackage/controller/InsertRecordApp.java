...
public class InsertRecordApp {
	...
	public static void main(String[] args) throws Exception {
		...
		try (FileInputStream fis = new FileInputStream("D:\\Ineuron Full Stack Java course\\20230310\\logo.jpeg.svg")) {
		...
		try {
			f = new File("D:\\Ineuron Full Stack Java course\\20230310\\FJSDJFS.txt");
