...
import in.mypackage.model.BankAccount;
...
public class SelectAppUsingHQL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Query<BankAccount> query = session.createQuery("from in.mypackage.model.BankAccount where balance>=:amt");
			...
			Query<BankAccount> query1 = session.createQuery("from in.mypackage.model.BankAccount where balance>=:amt");
